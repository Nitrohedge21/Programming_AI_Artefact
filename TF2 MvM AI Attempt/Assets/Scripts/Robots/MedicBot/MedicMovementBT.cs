...
// Behaviour Tree that handles the Movement for the MedicBOT
[RequireComponent(typeof(RobotBB))]
public class MedicMovementBT : MonoBehaviour
{
    #region AI Stuff
...
{
    private RobotBB zBB;
    private MedicMovementBT robotRef;
    bool FirstRun = true;
    public MedicFollow(Blackboard bb, MedicMovementBT zombay) : base(bb)
    {
        zBB = (RobotBB)bb;
        robotRef = zombay;
    }
...
{
    private MedicMovementBT robotRef;
    public MedicStopMovement(Blackboard bb, MedicMovementBT zombay) : base(bb)
    {
        robotRef = zombay;
    }
